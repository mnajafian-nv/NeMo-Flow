...
<pre className="rust-signature"><code dangerouslySetInnerHTML={{"__html": "pub struct FfiPluginContext(pub <a href=\"https://doc.rust-lang.org/1.96.1/std/primitive.pointer.html\">*mut </a><a href=\"../../nemo-relay/plugin/struct-pluginregistrationcontext\">PluginRegistrationContext</a>);"}} /></pre>
