...
- [ResponseCacheConfig](/reference/api/rust-library-reference/nemo-relay-adaptive/config/struct-responsecacheconfig): Configuration for the adaptive plugin's exact-match LLM response and opt-in tool-result cache feature.
