...
- [ResponseCacheConfig](/reference/api/rust-library-reference/nemo-relay-adaptive/config/struct-responsecacheconfig): Configuration for the adaptive plugin's LLM response and opt-in tool-result cache feature.
