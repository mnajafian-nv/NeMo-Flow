...
```python
def register_conditional_middleware_guardrail(name: str, kinds: set[RuntimeRegistrationKind], registration_name: str, reason: str) -> None
```
...
```python
async def register_conditional_middleware_guardrail(name: str, kinds: set[RuntimeRegistrationKind], registration_name: str, reason: str) -> ConditionalMiddlewareGuardrailHandle
```
...
```python
async def emit_mark(name: str, data: Json | None = None, metadata: Json | None = None, *, data_schema: DataSchema | Mapping[str, Json] | None = None, severity: LogSeverity | str | None = None, scope_stack_id: str | None = None, parent_scope_id: str | None = None) -> None
```
...
```python
async def emit_metric(name: str, measurements: Iterable[MetricMeasurement | Mapping[str, Json]], metadata: Json | None = None, *, scope_stack_id: str | None = None, parent_scope_id: str | None = None) -> None
```
