...
The example's `observe` feature group installs a subscriber, mark sanitizer,
...
Use the following procedure to verify all eight observation registrations without
...
Success means all eight observation registrations produce observable evidence, codec
