...
stream continuations. Relay still accepts existing raw ABI v2 and v3 binaries,
and native subscribers remain synchronous. Follow the [native Rust migration
